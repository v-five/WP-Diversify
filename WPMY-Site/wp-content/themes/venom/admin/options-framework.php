...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(__('Theme Options','venom'), __('Theme Options','venom'), 'edit_theme_options', 'options-framework','optionsframework_page');
...
?>
    ...
    <div class="new_options_container">
    	...
    	<div id="countrytabs" class="new_options_container_middle">
			...
			<ul class="shadetabs">
            	<li class="big"><a href="#country1"><h6><?php echo __('General', 'venom'); ?></h6><p><?php echo __('Settings', 'venom'); ?></p></a></li>
                <li class="small"><a href="#country2"><p><?php echo __('Social Settings', 'venom'); ?></p></a></li>
            	<li class="big"><a href="#country10"><h6><?php echo __('Logo Section', 'venom'); ?></h6><p><?php echo __('Settings', 'venom'); ?></p></a></li>       
                
                <li class="big"><a href="#country3"><h6><?php echo __('Header', 'venom'); ?></h6><p><?php echo __('Settings', 'venom'); ?></p></a></li>
                <li class="small"><a href="#country6"><p><?php echo __('Slider One Settings', 'venom'); ?></p></a></li>                 
                <li class="big"><a href="#country4"><h6><?php echo __('Layout', 'venom'); ?></h6><p><?php echo __('Settings', 'venom'); ?></p></a></li>
                <li class="small"><a href="#country5"><p><?php echo __('Biz One Settings', 'venom'); ?></p></a></li>  
                <li class="small"><a href="#country7"><p><?php echo __('Biz Four Settings', 'venom'); ?></p></a></li>               
                <li class="small"><a href="#country9"><p><?php echo __('Standard Blog Settings', 'venom'); ?></p></a></li>
                <li class="big"><a href="#country19"><h6><?php echo __('Portfolio', 'venom'); ?></h6><p><?php echo __('Settings', 'venom'); ?></p></a></li>                                             
                
                <li class="big"><a href="#country11"><h6><?php echo __('Footer', 'venom'); ?></h6><p><?php echo __('Settings', 'venom'); ?></p></a></li>                                             
            </ul>        
    	...
    	<div class="new_options_container_bottom">
        	<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( __('Save Options', 'venom' ) ); ?>" />
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( __('Restore Defaults', 'venom' ) ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'venom' ) ); ?>' );" />
        </div> 
        </form>        
        </div>
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'venom' ), 'updated fade' );
	...
	if ( isset( $_POST['update'] ) ) {
		...
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'venom' ), 'updated fade' );
		return $clean;
	}
