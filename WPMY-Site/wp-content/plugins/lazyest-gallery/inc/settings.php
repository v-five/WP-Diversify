...
class LazyestSettings {
  ...
  function do_actions() {
    ...
    if ( false !== $dangerous ) {    
      $lg_gallery->message = $dangerous ? __( 'For security reasons, Lazyest Gallery cannot use this folder. Folder set to default' ) : '';  
  ...
  function main_options() {  
    global $lg_gallery;    
		if ( defined( 'LAZYEST_GALLERY_ROOT' ) ) {
			$gallery_folder = LAZYEST_GALLERY_ROOT;   
		} else {			   
    	$gallery_folder = str_replace( '\\', '/', $lg_gallery->get_option( 'gallery_folder' ) );
    	$createfolder_url = add_query_arg( 'create_folder', $gallery_folder, admin_url( 'options-general.php?page=lazyest-gallery' ) );
		}
    $createpage_url = admin_url( 'post-new.php?post_type=page' );
    $poptions = array();
    if ( 0 < $this->pagecount )  {
    ...
    ?>    
    <div id="lg_main_options">
      <h3><?php esc_html_e( 'Main Gallery Options', 'lazyest-gallery'); ?></h3>
        <?php if ( $this->new_install ) : ?>
      <div> 
      ...
      <?php endif; ?>                
      <table id="lg_main_options_table" class="form-table">
        <tbody>
          <tr>
            <th scope="row"><label for="gallery_folder"><?php esc_html_e( 'Your Gallery Folder', 'lazyest-gallery' ); ?></label></th>
            <td>
            	<?php if( defined( 'LAZYEST_GALLERY_ROOT' ) ): ?>
            		<p><?php echo $gallery_folder; ?></p>
            	<?php else: ?>
	              <input name="lazyest-gallery[gallery_folder]" id="gallery_folder" value="<?php echo $gallery_folder ?>" size="60" class="code" type="text" /> <br />
								<p class="description"><?php esc_html_e( 'Relative to the WordPress installation folder', 'lazyest-gallery') ?></p>												            
	              <?php
	              ...
	              <?php endif; ?>
              <?php endif; ?>
             	<input type="hidden" name="lazyest-gallery[new_install]" value="<?php echo ( $this->new_install ) ? 'TRUE' : 'FALSE' ?>" />
            </td>
          </tr>
          <tr>
            ...
            <td>                  
              ...
              <p id="gallery_prev_p"><a href="<?php echo $lg_gallery->get_option( 'gallery_prev' ); ?>"><?php echo $lg_gallery->get_option( 'gallery_prev' ); ?></a></p>
          ...
          <tr>
          	<th scope="row">
						...
						<td>
							<a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&amp;hosted_button_id=1257529" title="<?php esc_html_e( 'Donate with PayPal', 'lazyest-gallery' ); ?>"><img src="https://www.paypal.com/en_US/NL/i/btn/btn_donateCC_LG.gif" alt="" /></a>
						</td>
					</tr>
        </tbody>
      </table>   
  ...
  function thumbnail_options() {
    global $lg_gallery;  
    ?>
    <div id="lg_thumbnail_options" class="<?php echo $this->installstyle; ?>" >
    <h3><?php esc_html_e( 'Thumbnail View Options' , 'lazyest-gallery' ); ?></h3>
    <table id="lg_thumbnail_options_table" class="form-table">
      <tbody>
        <tr>
          <th scope="row"><label for="thumbwidth"><?php esc_html_e( 'Maximum Thumbnail Width' , 'lazyest-gallery' ); ?></label></th>
          <td><input name="lazyest-gallery[thumbwidth]" id="thumbwidth" value="<?php echo $lg_gallery->get_option( 'thumbwidth' ); ?>" size="4" class="small-text" type="number" min="32" /> pixels</td>
        </tr>
        <tr>
          <th scope="row"><label for="thumbheight"><?php esc_html_e( 'Maximum Thumbnail Height', 'lazyest-gallery' ); ?></label></th>
          <td><input name="lazyest-gallery[thumbheight]" id="thumbheight" value="<?php echo $lg_gallery->get_option( 'thumbheight' ); ?>" size="4" class="small-text" type="number" min="32" /> pixels</td>
        </tr>								
        <tr>
          <th scope="row"><label for="thumbspage"><?php esc_html_e( 'Thumbnails per Page', 'lazyest-gallery' ); ?></label></th>
          <td><input name="lazyest-gallery[thumbs_page]" id="thumbs_page" value="<?php echo $lg_gallery->get_option( 'thumbs_page' ); ?>" size="4" class="small-text" type="number" min="0" /><br />
          <p class="description"><?php esc_html_e( 'Set to 0 to disable pagination.', 'lazyest-gallery' ); ?></p>
          </td>
        </tr>
        <tr>
          <th scope="row"><label for="folders_page"><?php esc_html_e( 'Folders per Page', 'lazyest-gallery' ); ?></label></th>
          <td><input name="lazyest-gallery[folders_page]" id="folders_page" value="<?php echo $lg_gallery->get_option( 'folders_page' ); ?>" size="4" class="small-text" type="number" min="0" /><br />
          <p class="description"><?php esc_html_e( 'Set to 0 to disable pagination.', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input name="lazyest-gallery[folders_columns]" id="folders_columns" value="<?php echo $lg_gallery->get_option( 'folders_columns' ); ?>" size="4" class="small-text" type="number" min="0" />
          	<?php if( 'TRUE' != $lg_gallery->get_option('table_layout') ) echo '<p class="description">' . esc_html__( 'Set to 0 for a maximum fill per row', 'lazyest-gallery' ) . '</p>'; ?>
					</td>
        </tr>
        <tr>
          <th scope="row"><label for="thumbs_columns"><?php esc_html_e( 'Thumbnail Columns', 'lazyest-gallery' ) ?></label></th>
          <td><input name="lazyest-gallery[thumbs_columns]" id="thumbs_columns" value="<?php echo $lg_gallery->get_option( 'thumbs_columns' ); ?>" size="4" class="small-text" type="number" min="0" />
          <?php if( 'TRUE' != $lg_gallery->get_option('table_layout') ) echo '<p class="description">' . esc_html__( 'Set to 0 for a maximum fill per row', 'lazyest-gallery' ) . '</p>'; ?>
					</td>
        </tr>			
        <tr>
  ...
  function slide_options() {
    global $lg_gallery;
    ?>
    <div id="lg_slide_options" class="<?php echo $this->installstyle; ?>">
      <h3><?php esc_html_e( 'Slide View Options', 'lazyest-gallery' ) ?></h3>
      <table id="lg_slide_options_table" class="form-table">
        <tbody>
        <tr>
        ...
        <tr>
          ...
          <td><input name="lazyest-gallery[pictwidth]" id="pictwidth" value="<?php echo $lg_gallery->get_option( 'pictwidth' ); ?>" size="4" class="small-text" type="number" min="32" /> pixels</td>
        </tr>
        <tr>
          <th><label for="pictheight"><?php esc_html_e( 'Maximum Slides Height', 'lazyest-gallery' ) ?></label></th>
          <td><input name="lazyest-gallery[pictheight]" id="pictheight" value="<?php echo $lg_gallery->get_option( 'pictheight' ); ?>" size="4" class="small-text" type="number" min="32" /> pixels</td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            <select name="lazyest-gallery[on_slide_click]">
              ...
              <option value="thickbox" <?php selected( 'thickbox', $lg_gallery->get_option( 'on_slide_click' ) ) ?>><?php esc_attr_e( 'Show image in Thickbox', 'lazyest-gallery' ) ?></option>
            </select>
            <p>
  ...
  function caption_options() {
    global $lg_gallery;
    ?>        
    <div id="lg_caption_options" class="<?php echo $this->installstyle; ?>">
      <h3><?php esc_html_e( 'Caption Options', 'lazyest-gallery' ) ?></h3>
      <table id="lg_caption_options_table" class="form-table">
        <tbody>
        <tr>
          <th scope="row">
						<label for="enable_captions"><?php esc_html_e( 'Use image captions instead of file names', 'lazyest-gallery' ) ?></label>
          </th>          
          <td>
						<input id="enable_captions" type="checkbox" name="lazyest-gallery[enable_captions]" value="TRUE" <?php checked ( 'TRUE', $lg_gallery->get_option( 'enable_captions' ) ); ?> />
            <p class="description"><?php esc_html_e( 'Use image captions instead of file names', 'lazyest-gallery' ) ?></p>
					</td>
        </tr>
        
        <tr>
          <th scope="row">
            <label for="use_folder_captions">              
              <?php esc_html_e( 'Use folder captions instead of folder names', 'lazyest-gallery' ) ?>
            </label>
          </th>
          <td>
						<input id="use_folder_captions" type="checkbox" name="lazyest-gallery[use_folder_captions]" value="TRUE" <?php checked( 'TRUE', $lg_gallery->get_option( 'use_folder_captions' ) ); ?> />
						<p class="description"><?php esc_html_e( 'Use folder captions instead of folder names', 'lazyest-gallery' ) ?></p>
					</td>
        </tr>
         
        <tr>
          <th scope="row">
            <label for="thumb_description">              
              <?php esc_html_e( 'Show descriptions in thumbnail view', 'lazyest-gallery' ) ?>
            </label>
          </th>
          <td>
          	<input id="thumb_description" type="checkbox" name="lazyest-gallery[thumb_description]" value="TRUE" <?php checked( 'TRUE', $lg_gallery->get_option( 'thumb_description' ) ); ?> />
          	<p class="description"><?php esc_html_e( 'Show descriptions in thumbnail view', 'lazyest-gallery' ) ?></p>
					</td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td>
          	...
          	<p class="description"><?php esc_html_e( 'Set to -1 to disable captions in thumbnail view.', 'lazyest-gallery' ); ?></p>
          	<p class="description"><?php esc_html_e( 'Set to  0 to disable cropping of captions text in thumbnail view.', 'lazyest-gallery' ); ?></p>
            <p class="description"><?php esc_html_e( 'Disable captions will also disable descriptions in thumbnail view.', 'lazyest-gallery' ); ?></p>
          </td>
        </tr>        
  ...
  function upload_options() {
    global $lg_gallery;
    ?>
    <div id="lg_upload_options" class="<?php echo $this->installstyle; ?>">
      <h3><?php esc_html_e( 'Upload Options', 'lazyest-gallery' ) ?></h3>
      ...
      <table id="lg_upload_options_table" class="form-table">
        <tbody>                    
        <tr>
          ...
          <td><input name="lazyest-gallery[fileupload_allowedtypes]" type="text" id="fileupload_allowedtypes" value="<?php echo $lg_gallery->get_option( 'fileupload_allowedtypes' ); ?>" size="40" />
            <p class="description"><?php printf( esc_html__( 'Recommended: %sjpg jpeg gif png%s. Separate extensions by spaces (" ").', 'lazyest-gallery' ), '<code>', '</code>' ) ?></p>
          </td>
        </tr>                                								
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Use the Adobe Flash Player to upload multiple images at once.', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>		
				<tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Read image meta data for newly add images', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>								
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Note: This feature is only supported for use with Microsoft Windows XP.', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>
  ...
  function advanced_options() {
    ...
    ?>
    <div id="lg_advanced_options" class="<?php echo $this->installstyle; ?>">
      <h3><?php esc_html_e( 'Advanced Options', 'lazyest-gallery' ) ?></h3>
      <table id="lg_advanced_options_table" class="form-table">
        <tbody>
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Blog Administrators are Lazyest Gallery Administrators by default', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>      
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Enable this to show Gallery Folders as subpages of your Gallery Page.', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Enable this to add a canonical link for the gallery in your page header.', 'lazyest-gallery' ) ?></p>
            <p class="description"><?php printf( esc_html__( 'This could interfere with SEO plugins. Please read %smore about canonical links%s', 'lazyest-gallery' ), '<a href="http://brimosoft.nl/2011/09/05/canonical-urls-revisited/">', '</a>' ); ?></p> 
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Enable this to show Gallery Folders and Images in the Wordpress search results.', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'List folders to exclude from the gallery.  Separate folders with commas (",") while omitting spaces.', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Valid settings range from 0 (low quality) to 100 (best quality).  This setting only applies to JPEG files.', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Enable this to jump to the Gallery after a user clicks on an folder shortcode in a post.', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Enable this to support Lazyest Gallery by showing the "Powered by Lazyest Gallery" banner below your gallery', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Enable this to skip the memory check. Warning, this could crash your gallery.', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Enable this to use a <table> element to display the gallery as in previous Lazyest Gallery versions.', 'lazyest-gallery' ) ?></p>
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e( 'Enable this to refresh the gallery without refreshing the whole page', 'lazyest-gallery' ) ?><br />
  ...
  function utilities() {
    global $lg_gallery;
    ?>
    <div id="utilitiesdiv" class="<?php echo $this->installstyle; ?>">    
      <h3><?php esc_html_e( 'Utility functions', 'lazyest-gallery' ) ?></h3>
      <table class="form-table">
      <tbody>
      <tr>
      <th scope="row">
				<?php esc_html_e( 'Cache', 'lazyest-gallery' ); ?>
			</th>
			<td>
        ...
        <div id="preview-action">
          <p><a class="button" href="admin.php?page=lazyest-gallery&amp;clear_cache" title="<?php esc_html_e( 'Clear thumbs and slides from your gallery', 'lazyest-gallery' ) ?>"><?php esc_html_e( 'Clear Cache', 'lazyest-gallery' ) ?></a></p>                            
			 ...
			 <tr>    
			 <th scope="row">
			 	<?php esc_html_e( 'Database', 'lazyest-gallery' ); ?>
			 </th>  
			 <td>
            <div>
              ...
              <p class="description"><?php echo __( 'Use this function if you see an increase in loading time for your comments.', 'lazyest-gallery' ) ?></p>
