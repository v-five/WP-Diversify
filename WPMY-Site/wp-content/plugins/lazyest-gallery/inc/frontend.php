...
class LazyestFrontendFolder extends LazyestFolder {
  ...
  function thumb_image( $image ) {  	
    ...
    return sprintf( '<div class="lg_thumb_image">%s<img class="%s" src="%s" alt="%s" />%s</div>',
			$anchor_1,                
      $class,
      $image->src(),
      $image->alt(),
      ...
      <table class="imagedatatable">
        <tbody>
          <tr>
            ...
            <td><?php echo esc_html($img_info[__('FileDateTime', 'lazyest-gallery')]); ?></td>
          </tr>
          <tr>
            <th scope="row"><?php esc_html_e( 'Height' ); ?></th>
            <td><?php echo esc_html($img_info[__('Height', 'lazyest-gallery')]); ?></td>
          </tr>
          <tr>
            <th scope="row"><?php esc_html_e( 'Width' ); ?></th>            
            <td><?php echo esc_html($img_info[__('Width', 'lazyest-gallery')]); ?></td>
          </tr>
          ...
          <tr>
            ...
            <td><?php echo esc_html($img_info[__('Make', 'lazyest-gallery')]) . ' - ' . esc_html($img_info[__('Model', 'lazyest-gallery')]); ?></td>
          </tr>
          <?php } ?>
        </tbody>
      </table>
