...
$restimpo_themever = "1.1.1";					//Theme version
...
function restimpo_content_nav( $html_id ) {
	...
	if ( $wp_query->max_num_pages > 1 ) : ?>
      ...
      <div class="nav-wrapper">
			<p class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'restimpo' ) ); ?></p>
			<p class="nav-next"><?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'restimpo' ) ); ?></p>
      </div>
		</div>
	<?php endif;
}
...
<div id="<?php echo $nav_id; ?>" class="navigation" role="navigation">
	<div class="nav-wrapper">
  <p class="nav-previous"><?php previous_post_link('%link', __( '&larr; Previous post' , 'restimpo' )); ?></p>
	<p class="nav-next"><?php next_post_link('%link', __( 'Next post &rarr;' , 'restimpo' )); ?></p>
   </div>
</div>
<?php }
