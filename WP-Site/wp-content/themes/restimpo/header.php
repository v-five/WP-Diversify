...
<?php if ( $restimpo_options_db['restimpo_header_image_headline'] != '' ) { ?>
        <p class="header-image-headline"><?php esc_attr_e($restimpo_options_db['restimpo_header_image_headline']); ?></p>
<?php } if ( $restimpo_options_db['restimpo_header_image_text'] != '' ) { ?>
        <p class="header-image-info"><?php esc_attr_e($restimpo_options_db['restimpo_header_image_text']); ?></p>
<?php } if ( $restimpo_options_db['restimpo_header_image_link_url'] != '' || $restimpo_options_db['restimpo_header_image_link_text'] != '' ) { ?>
        <a class="header-image-link" href="<?php echo esc_url($restimpo_options_db['restimpo_header_image_link_url']); ?>"><span><?php esc_attr_e($restimpo_options_db['restimpo_header_image_link_text']); ?></span></a>
<?php } ?>
      </div>
    </div>
  </div>
<?php } elseif ( $restimpo_options_db['restimpo_display_header_image'] == 'Everywhere' ) { ?>
  <div class="header-image">
  </div>
<?php } ?>
